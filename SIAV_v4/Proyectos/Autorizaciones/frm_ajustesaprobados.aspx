<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_ajustesaprobados.aspx.cs" Inherits="SIAV_v4.Proyectos.Autorizaciones.frm_ajustesaprobados" %>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>  
                <h1 class="page-header">Ajustes Aprobados</h1>
    ...
    <asp:GridView ID="gvAjustes" runat="server" AutoGenerateColumns="False" CellPadding="4" 
        ...
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:TemplateField>
              <ItemTemplate>
                  <asp:ImageButton CommandName="Aprobacion" CommandArgument="<%# Container.DataItemIndex %>" ImageUrl="~/Recursos/images/grafico.png" runat="server" OnClientClick="return confirm('Desea revocar la aprobación')" />
              </ItemTemplate>
            </asp:TemplateField>
