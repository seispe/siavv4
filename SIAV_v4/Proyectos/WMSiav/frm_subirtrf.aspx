<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_subirtrf.aspx.cs" Inherits="SIAV_v4.Proyectos.WMSiav.frm_subirtrf" %>
...
                <asp:ListItem Value="1" Selected="True">PVG</asp:ListItem>
                <asp:ListItem Value="2">NO CONFORME</asp:ListItem>
                <asp:ListItem Value="3">CUARENTENA</asp:ListItem>
            </asp:RadioButtonList> 
      </div>
    <br />
