<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_asigfamilias.aspx.cs" Inherits="SIAV_v4.Proyectos.WMSiav.frm_asigfamilias" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="gvProductos" runat="server" AutoGenerateColumns="False" CellPadding="8"
                    AllowPaging="True" AllowSorting="True" CssClass="grid" ForeColor="#333333" GridLines="None" PageSize="50" HorizontalAlign="Left" OnPageIndexChanging="gvProductos_PageIndexChanging">
