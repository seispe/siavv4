...
{
    public partial class frm_asigconteocuarentena : System.Web.UI.Page
    {
                    ...
                    foreach (GridViewRow row in gvProdFam.Rows)
                    {
                        if (row.RowType == DataControlRowType.DataRow)
                        {
                            ...
                            if (chkRow.Checked)
                            {
                                ...
                                salida = an_wms.InsConteoCiclicoCuarentena(1, tipo, "", 0, codigo, descripcion, "", "", empresa, 0, usuario, usuarioasigna);
                            }
                            else
                            {
