<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_LogisticaPVQ.aspx.cs" Inherits="SIAV_v4.Proyectos.Devoluciones.frm_LogisticaPVQ" %>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>  
                ...
                <h1 class="page-header">Devoluciones en Logistica</h1>
