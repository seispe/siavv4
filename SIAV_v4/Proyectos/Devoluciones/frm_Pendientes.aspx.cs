...
namespace SIAV_v4.Proyectos.Devoluciones
{
    public partial class frm_Pendientes : System.Web.UI.Page
    {
        ...
        protected void gvLogistica_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName.Equals("editRecord"))
                {
                    ...
                    {
                        an_devolucion.ModificarEstado(Request.Cookies["basesiav"].Value, id, "0", User.Identity.Name, "");
                        lblError.Text = an_alertas.Mensaje("ENVIADO...!", "Se envio a LOGISTICA", "verde");
                    }
                    VincularGrid();
                }
            }
        ...
        {
            gvLogistica.DataSource = an_devolucion.LlenarGrid(Request.Cookies["basesiav"].Value, "7", 0).DataSource;
