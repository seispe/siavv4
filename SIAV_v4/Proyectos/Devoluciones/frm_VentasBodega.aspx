<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_VentasBodega.aspx.cs" Inherits="SIAV_v4.Proyectos.Devoluciones.frm_VentasBodega" %>
...
<asp:UpdatePanel id="upCrudGrid" runat="server" ChildrenAsTriggers="true">
    <ContentTemplate>
        ...
        AllowSorting="True" OnRowCommand="gvVentas_RowCommand" OnPageIndexChanging="gvVentas_PageIndexChanging">
...
<asp:UpdateProgress id="updateProgress" runat="server">
    <ProgressTemplate>
        <div class="updateProgress">
            <span class="updateProgressHijo">Cargando...<img src="<% Response.Write(ConfigurationManager.AppSettings["PATH_RECURSOS"]); %>images/cargando.gif" /></span>
        </div>
    </ProgressTemplate>
</asp:UpdateProgress> 
</form>
