<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_subirpvcu.aspx.cs" Inherits="SIAV_v4.Proyectos.WMScalU.frm_subirpvcu" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Subir Transferencia</h1>
...
            </asp:RadioButtonList> 
    ...
    <div class="row">
        ...
        <asp:Button ID="btnSubir" runat="server" Text="Subir Orden Recepcion" CssClass="btn btn-success" Width="200px" OnClick="btnSubir_Click" />
    </div>
    <br />
</form>
</asp:Content>