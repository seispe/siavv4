...
{
    public partial class frm_vaciarccfamprodiavG : System.Web.UI.Page
    {
        ...
        protected void gvDetConteo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "VaciarCantidad")
                {
                    ...
                    an_wms.UpVaciarCoordenada(coordenada, Convert.ToInt32(ddlConteo.SelectedValue), producto, Request.Cookies["basesiav"].Value, 3);
        ...
        protected void btnVaciar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtCoordenada.Text.Length > 0 && Convert.ToInt32(ddlConteo.SelectedValue) != 0)
                {
                    ...
                    string salida = an_wms.UpVaciarCoordenada(coordenada, Convert.ToInt32(ddlConteo.SelectedValue), "", Request.Cookies["basesiav"].Value, 4);
        ...
        public void VincularDdlCC()
        {
            ...
            dsp = an_wms.GetMConteoCiclicoProdFam();
        ...
        public void GridDetalleConteo()
        {
            try
            {
                gvDetConteo.DataSource = an_wms.GetDetConteo(txtCoordenada.Text.Trim(), ddlConteo.SelectedValue, Request.Cookies["basesiav"].Value, 4).DataSource;
