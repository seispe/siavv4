<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_asigconteoiavG.aspx.cs" Inherits="SIAV_v4.Proyectos.WMSiavG.frm_asigconteoiavG" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Asignación Conteo Cíclico Bodega Matriz</h1>
