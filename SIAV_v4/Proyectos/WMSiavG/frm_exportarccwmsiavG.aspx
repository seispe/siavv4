<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_exportarccwmsiavG.aspx.cs" Inherits="SIAV_v4.Proyectos.WMSiavG.frm_exportarccwmsiavG" %>
    ...
    <asp:GridView ID="gvMaestros" runat="server" AutoGenerateColumns="False" CellPadding="4" 
        ...
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                 <asp:TemplateField>
              <ItemTemplate>
                  <asp:ImageButton CommandName="ExportarGP" CommandArgument="<%# Container.DataItemIndex %>" ImageUrl="~/Recursos/images/grafico.png" runat="server" OnClientClick="return confirm('Desea exportar al WMS')" />
              </ItemTemplate>
            </asp:TemplateField>
