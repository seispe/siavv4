...
{
    public partial class frm_DtosBodCal : System.Web.UI.Page
    {
        ...
        {
            an_compras = new AN_Compras("GPCAL");
        }
                    ...
                    foreach (GridViewRow row in gvDetPedidos.Rows)
                    {
                        if (row.RowType == DataControlRowType.DataRow)
                        {
                            ...
                            if (chkRow.Checked)
                            {
                                ...
                                resul = an_compras.InsDtosMercaderiaCAL(secuencial,lblBodega.Text, lblRuc.Text, lblCliente.Text, lblFactura.Text, Convert.ToDateTime(lblFecha.Text), item, descripcion, cantingreso, porcentajeingreso,
