<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_vaciarccg.aspx.cs" Inherits="SIAV_v4.Proyectos.WMScalG.frm_vaciarccg" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Vaciar Coordenadas Conteo</h1>
   ...
   <ContentTemplate>
    <asp:GridView ID="gvDetConteo" runat="server" AutoGenerateColumns="False" CellPadding="8"
       AllowPaging="True" AllowSorting="True" CssClass="grid"  ForeColor="#333333" GridLines="None" PageSize="1000" HorizontalAlign="Left" OnRowCommand="gvDetConteo_RowCommand">
        ...
        <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton CommandName="VaciarCantidad" CommandArgument="<%# Container.DataItemIndex %>" ImageUrl="~/Recursos/images/grafico.png" runat="server" OnClientClick="return confirm('Desa vaciar lo contado')" />
                    </ItemTemplate>
                </asp:TemplateField>
