<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_cierreg.aspx.cs" Inherits="SIAV_v4.Proyectos.WMScalG.frm_cierreg" %>
        ...
        <asp:UpdatePanel ID="upCrudGrid" runat="server" ChildrenAsTriggers="true">
            <ContentTemplate>
                <asp:GridView ID="gvDetallePicking" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    PageSize="200" OnSelectedIndexChanged="gvDetallePicking_SelectedIndexChanged" OnRowDataBound="gvDetallePicking_RowDataBound" OnRowCommand="gvDetallePicking_RowCommand">
