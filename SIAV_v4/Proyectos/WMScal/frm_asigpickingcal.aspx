<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_asigpickingcal.aspx.cs" Inherits="SIAV_v4.Proyectos.WMScal.frm_asigpickingcal" %>
...
<div style="height: 500px; overflow:scroll" class="col-sm-9 col-lg-9" pull-right>
   ...
   <ContentTemplate>
    ...
    <%--           <asp:TemplateField HeaderText="TIPODOC" SortExpression="TIPODOC">
            ...
            <asp:BoundField DataField="tipodoc" HeaderText="TIPO" Visible="true"/>
            <asp:BoundField DataField="iavec" HeaderText="IAVEC" Visible="true"/>
            <asp:BoundField DataField="bodegapi" HeaderText="PI" Visible="true"/>
        </Columns>
        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
        <HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
        <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
    ...
    <div class="modal fade" id="detPedido">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="container"></div>
                <div class="modal-body">
                   <asp:GridView ID="gvDetPed" runat="server" AutoGenerateColumns="False" CellPadding="8"
                   AllowPaging="True" AllowSorting="True" CssClass="grid"  ForeColor="#333333" GridLines="None" PageSize="50" OnRowDataBound="gvDetPed_RowDataBound" >
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:TemplateField HeaderText="Pedido" SortExpression="Pedido">
                            <ItemTemplate>
