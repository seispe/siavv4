<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="frm_asigconteo.aspx.cs" Inherits="SIAV_v4.Proyectos.WMScal.frm_asigconteo" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Asignación Conteo Cíclico</h1>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                ...
                <asp:DropDownList ID="ddlFamilia" runat="server" CssClass="form-control" Width="350px"></asp:DropDownList>
            </div>
            <div class="col-xs-2">
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <br />
                                <div class="row">
                                    <label class="col-md-2 col-sm-2 col-xs-12 label label-info">
                                        <h5>OBSERVACION:</h5>
                                    </label>
                                    <div class="col-xs-2">
