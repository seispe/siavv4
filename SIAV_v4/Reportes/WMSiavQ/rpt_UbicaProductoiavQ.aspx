<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_UbicaProductoiavQ.aspx.cs" Inherits="SIAV_v4.Reportes.WMSiavQ.rpt_UbicaProductoiavQ" %>
...
<div class="row">
    <div class="col-lg-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="page-header">Reporte Ubicación Productos Matriz</h1>
