<%@ Page Language="C#"  MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_PedidosBodegaDos.aspx.cs" Inherits="SIAV_v4.Reportes.WMStra.rpt_PedidosBodegaDos" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Reporte de Pedidos en 041301011</h1>
