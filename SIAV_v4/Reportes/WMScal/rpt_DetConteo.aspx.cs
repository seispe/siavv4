...
{
    public partial class rpt_DetConteo : System.Web.UI.Page
    {
        ...
        public void GridResumen()
        {
            try
            {
                gvResumen.DataSource = an_wmscal.GetUsuAsig("", 2);
                gvResumen.DataBind();
            }
            catch (Exception ex)
            {
        ...
        public void ExportToExcel()
        {
            ...
            GridView1.DataSource = an_wmscal.GetCCReportes(idMConteoCiclico,2).DataSource;
            GridView1.DataBind();
