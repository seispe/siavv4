...
{
    public partial class rpt_ConteoDetalladoC : System.Web.UI.Page
    {
        ...
        public void ExportToExcel()
        {
            ...
            if (rdbTipo.SelectedValue == "1") GridView1.DataSource = an_wmscal.GetConteoDetallado(1, txtDato.Text.Trim()).DataSource;
            if (rdbTipo.SelectedValue == "2") GridView1.DataSource = an_wmscal.GetConteoDetallado(2, txtDato.Text.Trim()).DataSource;
            GridView1.DataBind();
