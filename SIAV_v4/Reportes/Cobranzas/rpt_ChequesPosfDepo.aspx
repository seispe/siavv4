<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_ChequesPosfDepo.aspx.cs" Inherits="SIAV_v4.Reportes.Cobranzas.rpt_ChequesPosfDepo" %>
...
<div class="row">
    <div class="col-lg-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="page-header">Reporte Cheques Posfechados Depositados</h1>
   ...
   <ContentTemplate>
    ...
    <asp:GridView ID="gvchequesPosfDepo" runat="server" AutoGenerateColumns="False" CellPadding="8"
       AllowPaging="True" AllowSorting="True" CssClass="grid"  ForeColor="#333333" GridLines="None" PageSize="500" OnPageIndexChanging="gvchequesPosfDepo_PageIndexChanging">
        ...
        <asp:TemplateField HeaderText="RUC" SortExpression="RUC">
            ...
            <asp:TemplateField HeaderText="N VEND" SortExpression="N VEND">
             ...
             <asp:TemplateField HeaderText="RECIBO" SortExpression="RECIBO">
               ...
               <asp:TemplateField HeaderText="DOC GP" SortExpression="DOC GP" >
                <ItemTemplate>
                    <asp:Label ID="lbldocum_gp" runat="server" Text='<%# Bind("DOCUM_GP") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    </Columns>
