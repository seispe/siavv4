...
{
    public partial class rpt_CuentasxPagar : System.Web.UI.Page
    {
        ...
        {
            gvCuentas.DataSource = an_cobranzas.rpt_cuentasxpagar(empresa, fecha).DataSource;
            gvCuentas.DataBind();
        }
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            if (txtFecha.Text.Trim().Length > 0)
            {
                ...
                {
                    fecha = Convert.ToDateTime(txtFecha.Text.Trim()).ToString("yyyy-MM-dd");
                    GridView1.DataSource = an_cobranzas.rpt_cuentasxpagar(Request.Cookies["basesiav"].Value, fecha).DataSource;
                    GridView1.DataBind();
                }
                else
                {
                    GridView1.DataSource = an_cobranzas.rpt_cuentasxpagar(Request.Cookies["basesiav"].Value, txtFecha.Text.Trim()).DataSource;
                    GridView1.DataBind();
                }
