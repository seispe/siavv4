<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_Recaudacion.aspx.cs" Inherits="SIAV_v4.Reportes.Cobranzas.rpt_Recaudacion" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Reporte de Recaudación</h1>
    ...
    <%-- SELECCIONAR LAS FECHAS --%>
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-8">
          ...
          <asp:Button ID="btnGenerar" runat="server" CssClass="btn btn-success" Text="Generar" OnClick="btnGenerar_Click" />
    </div>
</form>
</asp:Content>
