...
{
    public partial class rpt_PackingListg : System.Web.UI.Page
    {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    if (pedidoActual == "" || pedidoActual != pedido)
                    {
                        ...
                        table1.AddCell(CeldaEspaciosTop(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(PhraseCell(new Phrase("Nombre:", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(PhraseCell(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(PhraseCell(new Phrase("Hora:", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(PhraseCell(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
