<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_Voidsg.aspx.cs" Inherits="SIAV_v4.Reportes.WMScalG.rpt_Voidsg" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Armado - Voids</h1>
