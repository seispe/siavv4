...
namespace SIAV_v4.Reportes.WMSiavG
{
    public partial class rpt_WmsVsGPiavG : System.Web.UI.Page
    {
        ...
        public void ExportToExcel()
        {
            ...
            if (rdbTipo.SelectedValue == "1")
            {
                ...
                {
                    GridView1.DataSource = an_wms.GetWMSvsGPIAV().DataSource;
                }
                else
                {
                    GridView1.DataSource = an_wms.GetWMSvsGP(1).DataSource;
                }
            }
