<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_AnulacionesiavG.aspx.cs" Inherits="SIAV_v4.Reportes.WMSiavG.rpt_AnulacionesiavG" %>
    ...
    <asp:GridView ID="gvAnulaciones" runat="server" AutoGenerateColumns="False" CellPadding="8"
       AllowPaging="True" AllowSorting="True" CssClass="grid"  ForeColor="#333333" GridLines="None" PageSize="150" >
        ...
        <asp:TemplateField HeaderText="Pedido" SortExpression="Pedido">
            ...
            <asp:TemplateField HeaderText="Promedio" SortExpression="Promedio">
                <ItemTemplate>
                    <asp:Label ID="lblpromedio" runat="server" Text='<%# Bind("promedio") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
