<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_BahiasxBultoQ.aspx.cs" Inherits="SIAV_v4.Reportes.Logistica.rpt_BahiasxBultoQ" %>
                ...
                <asp:GridView ID="gvDetalleBultos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="BULTOARMADO" SortExpression="BULTOARMADO">
                          ...
                          <%--<asp:TemplateField HeaderText="BULTOCONSOLIDADO" SortExpression="BULTOCONSOLIDADO" Visible="false">
                            <ItemTemplate>
