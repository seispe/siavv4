...
{
    public partial class rpt_BahiasxBultoQ : System.Web.UI.Page
    {
        ...
        protected void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            if (txtpedido.Text.Length > 0)
            {
                GridView1.DataSource = an_wms.getBahiasxBultos(txtpedido.Text.Trim(), 2, "", "").DataSource;
                GridView1.DataBind();
            }
            else
            {
                GridView1.DataSource = an_wms.getBahiasxBultos("", 1, txtfdesde.Text.Trim(), txtfhasta.Text.Trim()).DataSource;
                GridView1.DataBind();
            }
