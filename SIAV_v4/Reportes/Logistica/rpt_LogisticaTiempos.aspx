<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_LogisticaTiempos.aspx.cs" Inherits="SIAV_v4.Reportes.Logistica.rpt_LogisticaTiempos" %>
...
<div class="buscar">
  <div class="form-group">
    <div class="row">
        <label class="control-label col-lg-1 col-md-1 col-sm-3 col-xs-4">Fecha Inicio:</label>
