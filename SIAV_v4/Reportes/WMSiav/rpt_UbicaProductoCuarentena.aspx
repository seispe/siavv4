<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_UbicaProductoCuarentena.aspx.cs" Inherits="SIAV_v4.Reportes.WMSiav.rpt_UbicaProductoCuarentena" %>
...
<div class="row">
    <div class="col-lg-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="page-header">Reporte Ubicación Productos Cuarentena</h1>
