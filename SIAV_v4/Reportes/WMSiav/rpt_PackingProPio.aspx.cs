...
{
    public partial class rpt_PackingProPio : System.Web.UI.Page
    {
        ...
        public void GridNE()
        {
            try
            {
                ...
                {
                    gvNE.DataSource = an_wms.GetNE(txtPedido.Text.Trim(), 6).DataSource;
                    gvNE.DataBind();
                }
                else
                {
                    gvNE.DataSource = an_wms.GetNE("", 5).DataSource;
                    gvNE.DataBind();
                }
