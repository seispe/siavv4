...
{
    public partial class rpt_UbicaProductoCuarentena : System.Web.UI.Page
    {
        ...
        public void GridUbica()
        {
            try
            {
                gvUbicaProducto.DataSource = an_wms.GetUbicaProductoCuarentena(txtDato.Text.Trim(), Convert.ToInt32(rdbTipo.SelectedValue)).DataSource;
        ...
        public void ExportToExcel()
        {
            ...
            GridView1.DataSource = an_wms.GetUbicaProductoCuarentena(txtDato.Text.Trim(), Convert.ToInt32(rdbTipo.SelectedValue)).DataSource;
            GridView1.DataBind();
