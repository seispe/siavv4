<%@ Page Language="C#"  MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_PackingProPio.aspx.cs" Inherits="SIAV_v4.Reportes.WMSiav.rpt_PackingProPio" %>
...
<div class="row">
    <div class="col-lg-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="page-header">Reportes Notas de Entrega PRO PIO</h1>
