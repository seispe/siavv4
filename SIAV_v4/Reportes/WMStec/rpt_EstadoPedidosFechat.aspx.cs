...
{
    public partial class rpt_EstadoPedidosFechat : System.Web.UI.Page
    {
        ...
        public void ExportToExcel()
        {
            ...
            {
                GridView1.DataSource = an_wms.GetEstadoPedidoFecha(txtfdesde.Text.Trim(), txtfhasta.Text.Trim(), 3).DataSource;
                GridView1.DataBind();
            }
        ...
        public void PintarGrid()
        {
            foreach (GridViewRow row in gvEstadoPedidosFecha.Rows)
            {
                ...
                picking = (row.FindControl("lblentrega") as Label).Text;
                switch (picking.Trim())
                {
                    case "EN PROCESO":
                ...
                picking = (row.FindControl("lblrecibido") as Label).Text;
                switch (picking.Trim())
                {
                    case "01/01/1900 0:00:00":
                        row.Cells[16].BackColor = Color.LightCoral;
                        break;
                    default:
