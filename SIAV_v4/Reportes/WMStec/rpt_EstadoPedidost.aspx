<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_EstadoPedidost.aspx.cs" Inherits="SIAV_v4.Reportes.WMStec.rpt_EstadoPedidost" %>
    ...
    <asp:GridView ID="gvEstadoPedidos" runat="server" AutoGenerateColumns="False" CellPadding="8"
       ...
       OnPageIndexChanging="gvEstadoPedidos_PageIndexChanging"  >
        ...
        <asp:TemplateField HeaderText="PEDIDO" SortExpression="PEDIDO">
            ...
            <asp:TemplateField HeaderText="RECIBE DE LAAR" SortExpression="RECIBE DE LAAR" Visible="false">
                <ItemTemplate>
