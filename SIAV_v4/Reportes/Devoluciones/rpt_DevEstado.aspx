<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_DevEstado.aspx.cs" Inherits="SIAV_v4.Reportes.Devoluciones.rpt_DevEstado" %>
...
<asp:UpdatePanel id="upCrudGrid" runat="server" ChildrenAsTriggers="true">
    <ContentTemplate>
        ...
        <Columns>     
            ...
            <asp:TemplateField HeaderText="NotaCredito" SortExpression="NotaCredito">
                <ItemTemplate>
