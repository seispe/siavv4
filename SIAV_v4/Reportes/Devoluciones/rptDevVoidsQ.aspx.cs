...
{
    public partial class rptDevVoidsQ : System.Web.UI.Page
    {
        ...
        public void ExportToExcel()
        {
            ...
            GridView1.DataSource = an_devolucion.GetrptVoidsPVQ(txtdoc.Text.Trim(), op).DataSource;
            GridView1.DataBind();
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lbldetalle.Text = an_devolucion.GetDetallePVQ(txtdoc.Text.Trim(), op);
