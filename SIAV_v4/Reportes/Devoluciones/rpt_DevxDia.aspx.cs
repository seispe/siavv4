...
{
    public partial class rpt_DevxDia : System.Web.UI.Page
    {
        ...
        {
            gvDev.DataSource = an_devolucion.rpt_pordia(empresa, fechaDesde, fechaHasta, cliente, iddevolucion).DataSource;
            gvDev.DataBind();
        }
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            GridView1.DataSource = an_devolucion.rpt_pordia(Request.Cookies["basesiav"].Value, txtFechaDesde.Text.Trim(), txtFechaHasta.Text.Trim(), txtCliente.Text.Trim(), txtNumDevol.Text.Trim()).DataSource;
            GridView1.DataBind();
