...
{
    public partial class rpt_DevxDia64CalU : System.Web.UI.Page
    {
        ...
        public void ExportToExcel()
        {
            ...
            GridView1.DataSource = an_devolucion.GetDV64Unamuncho(txtfdesde.Text.Trim(), txtfhasta.Text.Trim(), Request.Cookies["basesiav"].Value, 1).DataSource;
            GridView1.DataBind();

            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition",
             "attachment;filename=rptDevoluciones64.xls");
            Response.Charset = "";
