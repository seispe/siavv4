<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_CostosDescarga.aspx.cs" Inherits="SIAV_v4.Reportes.Compras.rpt_CostosDescarga" %>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>  
                ...
                <h1 class="page-header">REPORTE DE COSTOS DE DESCARGA</h1>
...
<div class="buscar">
  <div class="form-group">
    <div class="row">
        <label class="control-label col-lg-1 col-md-1 col-sm-3 col-xs-4">Fecha Inicial:</label>
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-8">
            <asp:TextBox ID="txtFechaInicial" runat="server" Enabled="True" class="form-control" placeholder="Fecha Inicial"></asp:TextBox>
        </div>
        <label class="control-label col-lg-1 col-md-1 col-sm-3 col-xs-4">Fecha Final:</label>
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-8">
...
<asp:UpdatePanel id="upCrudGrid" runat="server" ChildrenAsTriggers="true">
    <ContentTemplate>
        ...
        cssclass="grid" datakeynames="CODIGO" forecolor="#333333"
        ...
        <Columns>     
            ...
            <asp:TemplateField HeaderText="NUM_DOCMENTO" SortExpression="NUM_DOCMENTO">
                <ItemTemplate>
                    <asp:Label ID="lblNUM_DOCMENTO" runat="server" Text='<%# Bind("NUM_DOCMENTO") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="TOTAL_COST_DESCARGA" SortExpression="TOTAL_COST_DESCARGA">
                <ItemTemplate>
                    <asp:Label ID="lblTOTAL_COST_DESCARGA" runat="server" Text='<%# Bind("TOTAL_COST_DESCARGA") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="COSTO_DESCARG" SortExpression="COSTO_DESCARG">
                <ItemTemplate>
                    <asp:Label ID="lblCOSTO_DESCARG" runat="server" Text='<%# Bind("COSTO_DESCARG") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField> 
            <asp:TemplateField HeaderText="DESC_COSTO_DESCARG" SortExpression="DESC_COSTO_DESCARG">
                <ItemTemplate>
                    <asp:Label ID="lblDESC_COSTO_DESCARG" runat="server" Text='<%# Bind("DESC_COSTO_DESCARG") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="VALOR_DESCARG" SortExpression="VALOR_DESCARG">
                <ItemTemplate>
                    <asp:Label ID="lblVALOR_DESCARG" runat="server" Text='<%# Bind("VALOR_DESCARG") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="COMPRA" SortExpression="COMPRA">
                <ItemTemplate>
                    <asp:Label ID="lblCOMPRA" runat="server" Text='<%# Bind("COMPRA") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>           
        </Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var dp = $("#<%=txtFechaInicial.ClientID%>");
            dp.datepicker({
                changeMonth: true,
                changeYear: true,
                format: "dd/mm/yyyy",
