<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_OrdenCompraGPWMS.aspx.cs" Inherits="SIAV_v4.Reportes.Compras.rpt_OrdenCompraGPWMS" %>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>  
                ...
                <h1 class="page-header">Reporte Orden de Compra GP y WMS</h1>
