...
{
    public partial class rpt_OrdenCompraGPWMS : System.Web.UI.Page
    {
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            if (txtOrdenCompra.Text.Trim().Length > 0)
            {
                ...
                GridView1.DataSource = an_compras.rpt_ordencompraGPWMS(Request.Cookies["basesiav"].Value, txtOrdenCompra.Text.Trim()).DataSource;
                GridView1.DataBind();

                Response.Clear();
                Response.Buffer = true;
                Response.AddHeader("content-disposition",
                 "attachment;filename=rptOrdenCompra.xls");
                Response.Charset = "";
