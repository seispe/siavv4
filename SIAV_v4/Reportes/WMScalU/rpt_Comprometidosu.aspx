<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_Comprometidosu.aspx.cs" Inherits="SIAV_v4.Reportes.WMScalU.rpt_Comprometidosu" %>
    ...
    <form runat="server" id="form1">
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Reporte de Comprometidos</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <asp:TextBox ID="txtproducto" runat="server" CssClass="form-control" Width="200px"></asp:TextBox>
            </div>
        </div>
        <div class="row">
            <label class="col-md-1 col-sm-1 col-xs-12 label label-info">
        ...
        <asp:UpdatePanel ID="UpdatePanel10" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="gvComprometidos" runat="server" AutoGenerateColumns="False" CellPadding="8"
                    AllowPaging="True" AllowSorting="True" CssClass="grid" ForeColor="#333333" GridLines="None" PageSize="400" OnPageIndexChanging="gvComprometidos_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cant Ped" SortExpression="Cant Ped">
                            <ItemTemplate>
                                <asp:Label ID="lblcant_pedido" runat="server" Text='<%# Bind("cant_pedido") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Cant Coordenada" SortExpression="Cant Coordenada">
                            <ItemTemplate>
                                <asp:Label ID="lblcant_coordenada" runat="server" Text='<%# Bind("cant_coordenada") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
