...
{
    public partial class rpt_PackingListu : System.Web.UI.Page
    {
        ...
        public void NotaEntrega()
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    System.Drawing.Image img = b.Encode(BarcodeLib.TYPE.CODE128, p, System.Drawing.Color.Black, System.Drawing.Color.White, 500, 50);
                    ...
                    if (pedidoActual == "" || pedidoActual != pedido)
                    {
                        ...
                        table2.SetWidths(new float[] { 0.3f, 0.7f, 0.3f, 0.7f });*/
                        ...
                        cell = PhraseCell(new Phrase("", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                        cell.Rowspan = 4;
                        cell.Colspan = 1;
                        table.AddCell(cell);
                        ...
                        table.AddCell(CeldaEspaciosBottom(new Phrase("Ciudad:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table.AddCell(CeldaEspaciosBottom(new Phrase(row["CIUDAD"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table.AddCell(CeldaEspaciosBottom(new Phrase("Tipo Pedido:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table.AddCell(CeldaEspaciosBottom(new Phrase(row["TIPO_PEDIDO"].ToString(), FontFactory.GetFont("Arial", 9, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        ...
                        table1.AddCell(CeldaEspaciosTop(new Phrase("", FontFactory.GetFont("Arial", 12, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(CeldaEspaciosTop(new Phrase("Recibido Conforme:", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        ...
                        table1.AddCell(CeldaEspaciosTop(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(CeldaEspaciosBottom(new Phrase("Nombre:", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(CeldaEspaciosBottom(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(CeldaEspaciosBottom(new Phrase("Hora:", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        table1.AddCell(CeldaEspaciosBottom(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        ...
                        //INICIA PROCESO DE SERVIENTREGA
                        /*var list = new List<string> { "IBARRA", "OTAVALO", "CAYAMBE", "CUENCA", "GUAYAQUIL", "RIOBAMBA", "LATACUNGA", "QUITO", "AMBATO", "CAÑAR", "AZOGUES", "RUMIÑAHUI" };
                        if (!list.Contains(row["CIUDAD"].ToString()))
                        {
                            cell = PhraseCell(new Phrase("_____________________________________________________________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                            cell.Colspan = 4;
                            table2.AddCell(cell);
                            cell = PhraseCell(new Phrase("SERVIENTREGA", FontFactory.GetFont("Arial", 12, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                            cell.Colspan = 4;
                            table2.AddCell(cell);
                            cell = PhraseCell(new Phrase(empresa, FontFactory.GetFont("Arial", 10, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                            cell.Colspan = 4;
                            ...
                            table2.AddCell(PhraseCell(new Phrase("Bodega:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["BODEGA"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("GUIA:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["Guia"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("Ruta:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["RUTA"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("Fecha:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["Fecha_Inicio"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("Teléfonos::", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["TELEFONOS"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("Cliente:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["CLIENTE"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            ...
                            table2.AddCell(PhraseCell(new Phrase("Ruc:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["RUC"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("Dirección:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["DIRECCION"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("Razon Social:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase(row["RAZON_SOCIAL"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(CeldaEspaciosBottom(new Phrase("Ciudad:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(CeldaEspaciosBottom(new Phrase(row["CIUDAD"].ToString(), FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(CeldaEspaciosBottom(new Phrase("PIEZAS:", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(CeldaEspaciosBottom(new Phrase(row["TOTAL_BULTOS"].ToString(), FontFactory.GetFont("Arial", 9, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));

                            table2.AddCell(PhraseCell(new Phrase("Firma:", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("Fecha y Hora:", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                            table2.AddCell(PhraseCell(new Phrase("__________________", FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK)), PdfPCell.ALIGN_LEFT));
                        }*/
                    }
                    else
