...
{
    public partial class rpt_Clientes_Cupos : System.Web.UI.Page
    {
        ...
        {
            gvDatos.DataSource = an_ventas.rpt_clientes_cupos(empresa).DataSource;
            gvDatos.DataBind();
        }
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            GridView1.DataSource = an_ventas.rpt_clientes_cupos(Request.Cookies["basesiav"].Value).DataSource;
            GridView1.DataBind();

            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition",
             "attachment;filename=rptCuposClientes.xls");
            Response.Charset = "";
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                GridView1.Rows[i].Cells[8].Attributes.Add("style", @"mso-number-format:'#,###.00'");
                GridView1.Rows[i].Cells[11].Attributes.Add("style", @"mso-number-format:'#,###.00'");
                GridView1.Rows[i].Cells[12].Attributes.Add("style", @"mso-number-format:'#,###.00'");
            }
