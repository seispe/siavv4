<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_infoPedidos.aspx.cs" Inherits="SIAV_v4.Reportes.Ventas.rpt_infoPedidos" %>
...
<div class="row">
    <div class="col-lg-12">
        <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="page-header">Reporte Pedidos WMS</h1>
...
                <asp:ListItem Value="2">PVQ</asp:ListItem>
                <asp:ListItem Value="3">PVG</asp:ListItem>
            </asp:RadioButtonList> 
        ...
        <asp:TemplateField HeaderText="PEDIDO" SortExpression="PEDIDO">
            ...
            <asp:TemplateField HeaderText="RECIBE" SortExpression="RECIBE">
             ...
             <asp:TemplateField HeaderText="FECHA ENTREGA" SortExpression="FECHA ENTREGA">
                ...
                <asp:TemplateField HeaderText="HORA ENTREGA" SortExpression="HORA ENTREGA">
                <ItemTemplate>
                    <asp:Label ID="lblhentrega" runat="server" Text='<%# Bind("horaentrega") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
