<%@ Page Language="C#" MasterPageFile="~/Plantilla/Menu.Master" AutoEventWireup="true" CodeBehind="rpt_VtasxCliVen.aspx.cs" Inherits="SIAV_v4.Reportes.Ventas.rpt_VtasxCliVen" %>
...
<asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <h1 class="page-header">Reporte de Ventas por Cliente</h1>
     ...
     <%-- SELECCIONAR LAS FECHAS --%>
      <div class="row">
           <label class="control-label col-lg-1 col-md-1 col-sm-3 col-xs-4">RUC:</label>
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-8">
            <asp:TextBox ID="txtRuc" runat="server" Enabled="True" class="form-control" ></asp:TextBox>
        </div>
