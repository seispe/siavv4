...
namespace AccesoDatos.WmstraB
{
    public class AD_WMStraB
    {
        ...
        public AD_WMStraB()
        {
            db = new SqlConnection(ConfigurationManager.ConnectionStrings["conWmstraB"].ConnectionString);
        ...
        public DataSet GetrptReversas(string dato1, string dato2, int op)
        {
            try
            {
        ...
        #region Update
        public string VaciarCoorCant(string dato, int op)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "GA_WMS_Pvaciarcoor";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@dato", dato);
                cmd.Parameters.AddWithValue("@op", op);
                cmd.Connection = db;
        ...
        public DataSet GetReportesWMStra(string doc, int op)
        {
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("GA_WMS_PReportesWMStra", db);
                da.SelectCommand.Parameters.AddWithValue("@documento", doc);
                da.SelectCommand.Parameters.AddWithValue("@op", op);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                DataSet ds = new DataSet();
                da.Fill(ds, "GA_WMS_PReportesWMStra");
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetCoorCont(string dato, int op)
        {
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("GA_WMS_Pvaciarcoor", db);
                da.SelectCommand.Parameters.AddWithValue("@dato", dato);
                da.SelectCommand.Parameters.AddWithValue("@op", op);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                DataSet ds = new DataSet();
                da.Fill(ds, "GA_WMS_Pvaciarcoor");
                return ds;
            }
            catch (Exception ex)
            {
