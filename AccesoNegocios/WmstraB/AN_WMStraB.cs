...
namespace AccesoNegocios.WmstraB
{
    public class AN_WMStraB
    {
        ...
        {
            return ad_wms.GetCoorCont(dato, op);
        }
        ...
        public string VaciarCoorCant(string dato, int op)
        {
            try
            {
                return ad_wms.VaciarCoorCant(dato, op);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public GridView GetrptReversas(string dato1, string dato2, int op)
        {
            DataSet dsp = new DataSet();
            GridView gv = new GridView();

            dsp = ad_wms.GetrptReversas(dato1, dato2, op);
        ...
        public GridView GetReportesWMStra(string doc, int op)
        {
            DataSet dsp = new DataSet();
            GridView gv = new GridView();

            dsp = ad_wms.GetReportesWMStra(doc, op);
