...
namespace AccesoNegocios.GP
{
    public class AN_Ventas
    {
        ...
        public GridView GetVtasCostoLogistico(string desde, string hasta, string bodega, string cliente)
        {
            DataSet dsp = new DataSet();
            GridView gv = new GridView();

            dsp = ad_ventas.GetVtasCostoLogistico(desde, hasta, bodega, cliente);
        ...
        public GridView GetRecepcionNE(string desde, string hasta, int op)
        {
            DataSet dsp = new DataSet();
            GridView gv = new GridView();

            dsp = ad_ventas.GetRecepcionNE(desde, hasta, op);
